...
class RokSprocketViewModule extends JView
{
	...
	protected function compileLess()
	{
		...
		RokCommon_Header::addStyle(JURI::base(true) . '/components/com_roksprocket/assets/styles/roksprocket.css?nocache=1.5.2');
	}
	...
	protected function compileJS()
	{
		...
		RokCommon_Header::addScript(JURI::base(true) . '/components/com_roksprocket/assets/js/roksprocket.js?nocache=1.5.2');
