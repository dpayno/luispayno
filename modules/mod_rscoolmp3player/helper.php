...
class modRSCoolMP3PlayerHelper {
	function getRSCoolMP3Player($module_id, $params) {
		...
		$rsws_file = $rsws_module_path.'xml'.DS.'rscoolmp3player_'.$module_id.'.xml';
