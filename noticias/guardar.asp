...
<title>N O T I C I A S - CONSTRUCCION INSTRUMENTOS TRADICIONALES</title>
  ...
  <table width="79%" border="0" cellspacing="0" cellpadding="0" height="21" align="center">
    ...
    <tr valign="middle"> 
      ...
      <td width="24%" bgcolor="#FFCC00">
        <div align="center"><a href="vermensaje.asp" style="text-decoration:none"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>INICIO 
          FORO</b></font></a> 
          <%
oConn.Close
Set oConn = nothing
